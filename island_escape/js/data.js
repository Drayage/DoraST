...
const RECIPES=[
  ...
  {id:'r_myc_chunk', cat:'생존', name:'균사 덩어리', icon:'🧫', result:'myc_chunk', rn:1, ap:1,
   cost:[{id:'mycelium',n:1},{id:'rotten_food',n:1}],
   desc:'균사로 썩은음식 정화. 균사×1+썩은음식×1 → 균사덩어리(허기+10, 썩지않음).'},
  {id:'r_myc_map', cat:'탈출', name:'균사지도', icon:'🗺️', result:'myc_map', rn:1, ap:1,
   cost:[{id:'myc_map_piece',n:3}],
   desc:'균사지도 조각×3 → 포자 제단 페이즈 도전 해금 지도.'},
  {id:'r_antidote', cat:'생존', name:'해독제', icon:'💊', result:'antidote', rn:1, ap:1,
