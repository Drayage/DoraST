...
const CARDS=[
  ...
  {id:'sk_mv_b', name:'가벼운 발', icon:'🥾', tag:'skill', tier:'bronze', atk:0, def:0, n:0,
   passiveDesc:'이동 AP -1 (최소 1)',
   desc:'패시브: 이동 시 AP 소비 -1.'},
  ...
  {id:'sk_mv_g', name:'자유로운 영혼', icon:'🦅', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'이동 AP -2 (최소 1)',
   desc:'패시브: 이동 시 AP 소비 -2.'},
  // 탐색 (explore)
  ...
  {id:'sk_ex_s1', name:'경험의 빛', icon:'🕯️', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'도구 탐색 성공 시 추가 카드 1장 드로우',
   desc:'패시브: 도구 판정 탐색 성공 시 추가 카드 1장 획득.'},
  ...
  {id:'sk_ex_s3', name:'기억', icon:'📖', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'사용: 현재 타일 재탐색 가능',
   desc:'사용: 현재 위치 탐색 완료 상태 초기화 → 재탐색 가능.', use:'sk_ex_reexplore'},
  ...
  {id:'sk_ga_s3', name:'현장 채집', icon:'🎒', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'사용: 현재 타일 즉시 수집 1회 (AP1)',
   desc:'사용: 현재 위치에서 AP 1 소비로 즉시 수집 1회.', use:'sk_ga_spot'},
  {id:'sk_ga_g', name:'황금 손', icon:'💰', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'수집·탐색 카드 보상 획득 시 +1장 추가',
   desc:'패시브: 수집 또는 탐색으로 카드를 얻을 때마다 같은 카드 1장 추가.'},
  // 캠프건설 (camp)
  {id:'sk_cp_b', name:'재빠른 건설', icon:'🏕️', tag:'skill', tier:'bronze', atk:0, def:0, n:0,
   passiveDesc:'캠프 건설 AP -2 (8→6)',
   desc:'패시브: 캠프 건설 비용 8 → 6 AP.'},
  ...
  {id:'sk_cp_s2', name:'안전한 야영지', icon:'🛡️', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'캠프 위치 취침 이벤트 확률 -10%',
   desc:'패시브: 캠프에서 취침 시 이벤트 발생 확률 -10%.'},
  {id:'sk_cp_s3', name:'모닥불의 온기', icon:'🔥', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'캠프 취침 시 꿀잠 카드 1장 자동 생성',
   desc:'패시브: 캠프에서 취침할 때 꿀잠 카드 1장을 덱에 추가.'},
  {id:'sk_cp_g', name:'야영의 달인', icon:'🏰', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'캠프 건설 AP 비용 0',
   desc:'패시브: 캠프 건설 비용 완전 무료.'},
  // 제작 (craft)
  ...
  {id:'sk_cr_s2', name:'재활용', icon:'🔄', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'제작 완료 후 버림더미 자원 카드 1장 덱으로 복귀',
   desc:'패시브: 제작 완료 후 버림더미의 자원 카드 1장을 덱으로 회수.'},
  {id:'sk_cr_s3', name:'이동 제작소', icon:'🗂️', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'사용: 캠프 없이 제작 1회 가능',
   desc:'사용: 다음 제작 1회를 캠프 외 어느 위치에서나 가능.', use:'sk_cr_anywhere'},
  {id:'sk_cr_g', name:'거장', icon:'🏭', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'모든 제작 AP 비용 0',
   desc:'패시브: 모든 제작이 완전 무료.'},
  // 카드사용 (carduse)
  {id:'sk_cu_b', name:'드로우 마스터', icon:'🃏', tag:'skill', tier:'bronze', atk:0, def:0, n:0,
   passiveDesc:'카드사용 드로우 +1장',
   desc:'패시브: 카드사용 시 드로우 수 +1.'},
  {id:'sk_cu_s1', name:'손놀림', icon:'🔀', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'카드사용 종료 시 버림더미 맨 위 1장 덱으로 복귀',
   desc:'패시브: 카드사용 창 닫을 때 버림더미 맨 위 카드 1장을 덱으로 복귀.'},
  ...
  {id:'sk_cu_s3', name:'선견지명', icon:'👁️', tag:'skill', tier:'silver', atk:0, def:0, n:0,
   passiveDesc:'사용: 덱 위 3장 확인 후 1장 선택 드로우',
   desc:'사용: 덱 맨 위 3장을 보고 1장을 손패에 추가, 나머지는 버림.', use:'sk_cu_peek'},
  {id:'sk_cu_g', name:'신속한 손', icon:'⚡', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'카드사용 AP 비용 0',
   desc:'패시브: 카드사용 창 열기 AP 비용 없음.'},
  // 취침 (sleep)
  ...
  {id:'sk_sl_s3', name:'낮잠', icon:'💤', tag:'skill', tier:'silver', atk:0, def:0, n:0, dur:1,
   passiveDesc:'사용: HP +8, 정신력 +4 즉시 회복 (1회용)',
   desc:'사용: HP +8, 정신력 +4 즉시 회복. 1회용.', use:'sk_sl_nap'},
  ...
  // 전투 (combat)
  {id:'sk_cb_b', name:'전투 감각', icon:'⚔️', tag:'skill', tier:'bronze', atk:0, def:0, n:0,
   passiveDesc:'전투 드로우 +1장 (5→6장)',
   desc:'패시브: 전투 시작 시 카드 1장을 더 드로우.'},
  {id:'sk_cb_s1', name:'단련된 몸', icon:'🦾', tag:'skill', tier:'silver', atk:0, def:0, n:0,
  ...
  {id:'sk_cb_g', name:'공허의 칼날', icon:'🌪️', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'전투 승리 시 덱·버림의 잔해/상태이상 1장 자동 소멸',
   desc:'패시브: 전투 승리 시 잔해 또는 상태이상 카드 1장 자동 제거.'},
];
...
const SKILL_POOL = {
  ...
  carduse: ['sk_cu_b','sk_cu_s1','sk_cu_s2','sk_cu_s3','sk_cu_g'],
