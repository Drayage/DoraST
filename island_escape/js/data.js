...
const CARDS=[
  ...
  {id:'sk_cu_g', name:'신속한 손', icon:'⚡', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'[사용] 손패의 카드 무작위 1장 소멸',
   desc:'사용: 현재 손패에서 무작위 카드 1장을 영구 소멸시킨다. 덱 정화 효과.', use:'sk_cu_discard'},
  // 취침 (sleep)
  ...
  {id:'sk_sl_s3', name:'꿈에서 깨다', icon:'⏰', tag:'skill', tier:'silver', atk:0, def:0, n:0, dur:1,
   passiveDesc:'[사용·1회용] AP +10 즉시 회복',
   desc:'사용: AP +10 즉시 회복. 1회용.', use:'sk_sl_wake'},
  ...
  {id:'sk_cb_g', name:'힘을 담은 일격', icon:'💥', tag:'skill', tier:'gold', atk:0, def:0, n:0,
   passiveDesc:'[사용] 전투 핸드에서 즉발: 적 HP-10 + 스턴 (보스 35%)',
   desc:'사용: 전투 핸드에서 즉시 발동. 적 HP-10, 스턴 1라운드 (보스는 35% 확률).', use:'sk_cb_strike'},
];
